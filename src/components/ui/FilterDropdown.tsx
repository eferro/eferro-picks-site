...
export function FilterDropdown({
  ...
  return (
    <Menu as="div" className={`relative inline-block text-left ${className}`}>
      ...
      >
        <Menu.Items className={`absolute left-0 z-50 mt-2 w-48 sm:w-56 origin-top-left ${allowMultiple ? 'divide-y divide-gray-100' : ''} rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none ${maxHeight} overflow-y-auto`}>
          <div className="py-1">
            {showAnyOption && (
              <Menu.Item>
